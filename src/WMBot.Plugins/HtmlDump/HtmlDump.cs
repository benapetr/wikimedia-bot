...
namespace wmib.Extensions
{
    ...
    public class HtmlDump : Module
    {
        public override bool Construct()
        {
            ...
            WebPages.WebpageURL = Configuration.RetrieveConfig("web", "");
            WebPages.Css = Configuration.RetrieveConfig("style_html_file", "");
            return true;
        }
    ...
    public class HtmlDumpObj
    {
        ...
        private static string CreateHeader(string page_name)
        {
            ...
            if (WebPages.Css != "")
            {
                html += "<link rel=\"stylesheet\" href=\"" + WebPages.Css + "\" type=\"text/css\"/>";
            }
